...
def _arm_usd_path() -> str:
    # Deferred import: isaaclab.sim.converters pulls carb/Omni (Isaac Sim
    # development-time converter). Keep this module importable kitless (Newton);
    # conversion only runs at spawn time under Isaac Sim.
