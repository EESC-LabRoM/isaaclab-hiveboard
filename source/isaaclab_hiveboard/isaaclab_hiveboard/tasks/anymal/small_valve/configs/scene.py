...
from isaaclab_hiveboard.tasks.scenes.small_valve import (
    SmallValveSceneCfg as SmallValveSceneBase,
)
...
@configclass
class SmallValveSceneCfg(SmallValveSceneBase):
    """ANYmal + DynaArm + shared HiveBoard small gate valve scene."""
