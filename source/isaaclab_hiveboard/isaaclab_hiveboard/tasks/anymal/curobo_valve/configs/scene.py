...
"""Bench board/valve scene with a fixed-base ANYmal-D + DynaArm + 2F-140.

Board, stand, valve, and camera poses are identical to the Spot bench scene so
both robots track the same traj_edit TCP beads. Only the robot asset differs.
"""
...
@configclass
class AnymalBenchValveSceneCfg(InteractiveSceneCfg):
