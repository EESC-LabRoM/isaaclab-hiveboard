...
from isaaclab_hiveboard.tasks.scenes.high_torque_valve import (
    HighTorqueValveSceneCfg as HighTorqueValveSceneBase,
)
...
@configclass
class HighTorqueValveSceneCfg(HighTorqueValveSceneBase):
    """ANYmal + DynaArm + shared HiveBoard high-torque gate valve scene."""
