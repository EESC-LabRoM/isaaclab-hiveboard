...
class CircuitBreakerSceneCfg(InteractiveSceneCfg):
    """Spot + HiveBoard circuit breaker in the Isaac warehouse."""

    # robot
    robot: ArticulationCfg = SPOT_ARM_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")

    # Isaac Sim small warehouse backdrop
    ...
    # Visual honeycomb panel parented under the Circuit Breaker base link
