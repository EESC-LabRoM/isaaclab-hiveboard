...
"""Isaac Lab 3 configuration for the kitless Spot high-torque valve task."""
...
from isaaclab_hiveboard.tasks.spot.high_torque_valve.configs.commands import FramePoseCommandsCfg
from isaaclab_hiveboard.tasks.spot.high_torque_valve.configs.events import ValveEventCfg, ValvePlayEventCfg
...
@configclass
class SpotHighTorqueValvePhysicsCfg(PresetCfg):
...
class SpotHighTorqueValveEnvCfg(ManagerBasedRLEnvCfg):
    """Randomized fixed-base Spot task that spins the high-torque handwheel."""
    ...
    sim: SimulationCfg = SimulationCfg(dt=1 / 200, render_interval=1, physics=SpotHighTorqueValvePhysicsCfg())  # type: ignore
    rewards = None
    ...
    def __post_init__(self):
        ...
        self.actions.gripper_action.close_command_expr = {"arm_f1x": -0.9}


@configclass
class SpotHighTorqueValveEnvCfg_PLAY(SpotHighTorqueValveEnvCfg):
